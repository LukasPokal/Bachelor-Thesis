...
//  Modified By :
//  Lukas Pokal
//  lukas.pokal@reutlingen-university.de
//
//******************************************************************************
...
int main(void)
{
  ...
  /*
    ...
    while (UCB0CTL1 & UCTXSTP);         // Ensure stop condition got sent
  */
  //endless loop to read sensor data and print to COM-port
  //goes to sleep after one loop
  //waiting until button p1.3 is pressed
  while(1){
...
__interrupt void Port_1(void)				//interrupt routine to wake up
{
